...
onedark_green="#749e99"
onedark_orange="#c99a6e"
...
set "@prefix_highlight_bg" "$onedark_orange"
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_orange, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_orange]"
set "status-left" "#[fg=$onedark_black,bg=$onedark_orange,bold] #S #{prefix_highlight}#[fg=$onedark_orange,bg=$onedark_black,nobold,nounderscore,noitalics]"
...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_orange,bg=$onedark_visual_grey,nobold] #I  #W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
